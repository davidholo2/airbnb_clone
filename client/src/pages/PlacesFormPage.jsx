...
export default function PlacesFormPage() {
  ...
  async function savePlace(ev) {
    ...
    try {
      if (id) {
        console.log("Updating existing place:", "/account/places/" + id);
        await axios.put("/account/places/" + id, placeData);
      } else {
        console.log("Creating new place:", "/places");
  ...
  return (
    <div>
      ...
      <form onSubmit={savePlace}>
        ...
        <input
          type="text"
          placeholder="title,for example:My lovley apt "
          value={title}
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-2 mt-2">
          <Perks selected={perks} onCheckboxChange={handlePerkCheckboxClick} />
        </div>
